  ...
  return (
    <div className='flex-1 flex flex-col overflow-hidden '>
      ...
      <div className='flex items-center gap-3'>
          <img src={userData?.profilePic} alt="" className='w-16 h-16 rounded-full cursor-pointer' />
          <p className='text-md font-semibold select-none'>{"Muhammad Awais"}</p>
      </div>
    ...
    <div className='bg-[#f0f2f5] h-14 flex items-center px-5 gap-5'>
      ...
      <div className='text-[rgb(59,74,84)] text-2xl cursor-pointer'  onClick={sendMessage}><IoIosSend /></div>
